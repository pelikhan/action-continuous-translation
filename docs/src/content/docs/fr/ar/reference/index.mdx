...
Nombre maximal de jetons (Tokens) pouvant être traités dans un appel de traduction à l'aide du LLM.
...
Nombre maximal de jetons (Tokens) pouvant être traités dans un appel de validation à l'aide du LLM.
