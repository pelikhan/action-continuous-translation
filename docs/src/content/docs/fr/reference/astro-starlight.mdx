...
<Steps>
  <ol>
    ...
    <li>
      Si vous avez également défini l'option [Astro `base`](https://docs.astro.build/en/reference/configuration-reference/#base),
      vous devez également fournir l'entrée `starlight_base`.
...
Vous pouvez utiliser le [Tableau de bord de traduction Lunaria](https://lunaria.dev/integrations/starlight/) pour générer
un tableau de bord de statut de traduction pour votre site Starlight.
