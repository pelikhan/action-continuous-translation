...
Consulte [Modelos](../../reference/models/) para mais detalhes sobre outros provedores como OpenAI, Azure OpenAI, etc.
...
Base para o alias da documentação [Astro Starlight](../../reference/astro-starlight/).
Se você não definir a [opção `base` do Astro](https://docs.astro.build/en/reference/configuration-reference/#base), não configure esta opção.
