...
- [وثائق العنوان](https://starlight.astro.build/guides/i18n/#translate-the-site-title)
- [وثائق الشريط الجانبي](https://starlight.astro.build/guides/sidebar/)
...
يمكنك تجربة لوحة المعلومات من خلال الانتقال إلى رابط **لوحة معلومات الترجمة** في الشريط الجانبي لهذه الصفحة.
