...
انظر [النماذج](../../reference/models/) لمزيد من التفاصيل حول موفرين آخرين مثل OpenAI وAzure OpenAI وغيرهم.
...
إذا لم تقم بتعريف خيار [الأساس لـ Astro](https://docs.astro.build/en/reference/configuration-reference/#base)، فلا تقم بتعيين هذا الخيار.
