...
This web site is translated using AI, check out the other languages (upper right)...
...
<CardGrid>
  ...
  <Card title="JSON Configuration" icon="setting">
    NEW! Translate Starlight configuration strings and enable multi-lingual
    titles for your documentation site.
  </Card>
</CardGrid>
...
- **NEW!** JSON configuration translation for multi-lingual titles and site configuration
