...
<Steps>
  <ol>
    ...
    <li>
      Si también has configurado la [opción `base` de Astro](https://docs.astro.build/en/reference/configuration-reference/#base),
...
Las entradas `title` y `sidebar` en el frontmatter no se traducen automáticamente mediante la acción.
...
* [Documentación del Título](https://starlight.astro.build/guides/i18n/#translate-the-site-title)
* [Documentación de la Barra Lateral](https://starlight.astro.build/guides/sidebar/)
...
Puedes probar el panel navegando al enlace **Panel de Traducción** en la barra lateral de esta página.
