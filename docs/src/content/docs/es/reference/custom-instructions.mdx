...
El objeto `translator` es una instancia de [configuración](../../reference/configuration/) y se valida en tiempo de ejecución.
Se elimina del frontmatter antes de que comience la traducción, por lo que no afecta al resultado final.
